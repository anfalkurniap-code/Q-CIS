...
<head>
    ...
    <title>Login Kepala Toko - Q-CIS SMK Mart</title>
        ...
        <div class="p-6 pt-5">
            ...
            @if (session('error'))
                <div class="mb-4 p-3 bg-rose-50 border border-rose-200 text-rose-700 text-xs rounded-xl font-semibold flex items-center gap-2">
                    <svg class="w-4 h-4 shrink-0 text-rose-600" fill="none" viewBox="0 0 24 24" stroke-width="2">
            ...
            <form action="{{ url('/LoginKepalaToko') }}" method="POST" class="space-y-4">
                @csrf
