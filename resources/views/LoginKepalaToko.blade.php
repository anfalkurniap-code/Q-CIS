...
<head>
    ...
    <!-- Tailwind CSS CDN (atau via Vite) -->
...
<body class="bg-slate-50 min-h-screen flex items-center justify-center p-4">
    ...
    <!-- Container Utama Mode Ponsel/Card -->
    <div class="w-full max-w-sm bg-white rounded-2xl shadow-sm border border-slate-100 p-6 relative flex flex-col justify-between min-h-[600px]">
        ...
        <div>
            <!-- Tombol Kembali -->
            <button class="w-9 h-9 border border-emerald-500 rounded-lg flex items-center justify-center text-emerald-600 hover:bg-emerald-50 transition">
            ...
            <div class="bg-white border border-slate-200/80 rounded-xl p-5 shadow-xs">
                <form action="{{ url('/LoginKepalaToko') }}" method="POST" x-data="{ showPassword: false }">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="login" placeholder="nama@gmail.com" required
                    ...
                    <!-- Tombol Masuk -->
                    <button type="submit" class="w-full bg-emerald-800 hover:bg-emerald-900 text-white font-medium py-2.5 px-4 rounded-lg text-xs flex items-center justify-center gap-2 shadow-sm transition">
        ...
        <div class="mt-6 text-center">
            <p class="text-xs text-slate-600">
                Belum punya akses? 
                <a href="#" class="font-bold text-emerald-800 hover:underline">Hubungi Admin Sekolah untuk Pendaftaran</a>
            </p>
